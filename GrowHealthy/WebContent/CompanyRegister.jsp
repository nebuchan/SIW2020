...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-sm-9" id="content">
            ...
            <p>Se sei un cliente, clicca <a href="UserRegister.jsp">qui</a>.</p>
            <form class="form-horizontal" method="POST" action="companyRegister">
            
                    <p>INFORMAZIONI AZIENDALI</p>
                    
                    <div class="form-group required">
                        <label for="input-pIva" class="col-sm-2 control-label">Partita Iva</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="input-pIva" placeholder="Partita Iva"  name="pIva">
                        </div>
                    </div>
                    <div class="form-group required">
                        <label for="input-ragioneSociale" class="col-sm-2 control-label">Ragione Sociale</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="input-ragioneSociale" placeholder="Ragione Sociale"  name="ragioneSociale">
                        </div>
                    </div>
                    <div class="form-group required">
                        <label for="input-sedeLegale" class="col-sm-2 control-label">Sede Legale</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="input-sedeLegale" placeholder="Sede Legale"  name="sedeLegale">
                        </div>
                    </div>
                    <div class="form-group required">
                        <label for="input-referente" class="col-sm-2 control-label">Referente</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="input-referente" placeholder="Referente"  name="referente">
                        </div>
                    </div>
                    <div class="form-group required">
                        <label for="input-telephone" class="col-sm-2 control-label">Numero Telefono</label>
                        <div class="col-sm-10">
                            <input type="tel" class="form-control" id="input-telephone" placeholder="Numero Telefono"  name="telefono">
                        </div>
                    </div>
                    <div class="form-group required">
                        <label for="input-descrizione" class="col-sm-2 control-label">Descrizione</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="input-descrizione" placeholder="Descrizione"  name="descrizione">
                        </div>
                    </div>
                ...
                <div class="buttons">
                    <div class="pull-right">I have read and agree to the <a class="agree" href="#"><b>Privacy Policy</b></a>
                        ...
                        &nbsp;
                        <button type="submit" class="btn btn-primary" value="RegistrazioneCliente">Continue </button>
                    </div>
                </div>
            </form>
        </div>
