	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-9" id="content">
				...
				<form class="form-horizontal" method="POST" action="insertterrain" id="formPopup" enctype="multipart/form-data">
					...
					<div class="buttons">
						<div class="form-group required">
							<br>
							<label for="input-immagine" class="col-sm-2 control-label"><strong>INSERISCI IMMAGINE TERRENO</strong></label>
							<div class="col-sm-10">
						...
						<div class="pull-right">
							...
							<button type="submit" class="btn btn-primary"
								value="InserimentoTerreno">Conferma</button>
						</div>
					</div>
				</form>
			</div>
