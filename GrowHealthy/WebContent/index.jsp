									...
									<ul class="dropdown-menu dropdown-menu-right">
										<li>
											...
											<form class="form-horizontal" action="login" method="post">
												...
												<c:if test="${utente != null}">
													<h1>Benvenuto ${utente.email}</h1>
													<br>

													<button type="submit" class="btn btn-default"
														formaction="logout" formmethod="post"
		...
		<div class="nav-inner container">
			...
			<div class="navbar-collapse">
				<ul class="main-navigation">
					...
					<li><a href="index.html" class="parent">Terreni</a></li>
					<li><a href="index.html" class="parent">Prodotti</a></li>
					<li><a href="category.html" class="parent">Categorie</a></li>
