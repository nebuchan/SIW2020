        ...
        <div class="col-sm-9" id="content">
            ...
            <form class="form-horizontal" method="POST" action="register">
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="input-firstname" placeholder="Nome"  name="nome">
                        </div>
                    </div>
                    <div class="form-group required">
                        <label for="input-lastname" class="col-sm-2 control-label">Cognome</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="input-lastname" placeholder="Cognome"  name="cognome">
                        </div>
                    </div>
                    <div class="form-group required">
                        <label for="input-email" class="col-sm-2 control-label">Codice Fiscale</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="input-email" placeholder="Codice Fiscale"  name="cf">
                        </div>
                    </div>
                     <div class="form-group required">
                        <label for="input-email" class="col-sm-2 control-label">Data di Nascita</label>
                        <div class="col-sm-10">
                            <input type="date" class="form-control" id=input-date placeholder="Data di Nascita"  name="data">
                        </div>
                    </div>
                    <div class="form-group required">
               ...
               <p>INDIRIZZO</p>
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="input-address-1" placeholder="Via"  name="via">
                        </div>
                    </div>
                    <div class="form-group required">
                        <label for="input-city" class="col-sm-2 control-label">Città</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="input-city" placeholder="Città"  name="citta">
                        </div>
                    </div>
                    <div class="form-group required">
                        <label for="input-postcode" class="col-sm-2 control-label">CAP</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="input-postcode" placeholder="CAP"  name="cap">
                        </div>
                    </div>
